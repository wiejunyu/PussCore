...
namespace Puss.BusinessCore
{
	public class Cms_SysconfigManager : ICms_SysconfigManager
	{
        ...
        {
            return await Db.Queryable<Cms_Sysconfig>().Where(whereExpression).SingleAsync();
        }
        ...
        public virtual async Task<Cms_Sysconfig> GetSingleDefaultAsync(Expression<Func<Cms_Sysconfig, bool>> whereExpression)
        {
            ...
            try
            {
                temp = await Db.Queryable<Cms_Sysconfig>().Where(whereExpression).SingleAsync();
            }
            catch
            {
            }
        ...
        {
            return await Db.Queryable<Cms_Sysconfig>().Where(whereExpression).ToListAsync();
        }
        ...
        public virtual async Task<List<Cms_Sysconfig>> GetPageListAsync(Expression<Func<Cms_Sysconfig, bool>> whereExpression, PageModel pageModel)
        {
            ...
            List<Cms_Sysconfig> result = await Db.Queryable<Cms_Sysconfig>().Where(whereExpression).ToPageListAsync(pageModel.PageIndex, pageModel.PageSize, re);
        ...
        public virtual async Task<List<Cms_Sysconfig>> GetPageListAsync(Expression<Func<Cms_Sysconfig, bool>> whereExpression, PageModel pageModel, Expression<Func<Cms_Sysconfig, object>> orderByExpression = null, OrderByType orderByType = OrderByType.Asc)
        {
            int totalNumber = 0;
            RefAsync<int> re = new RefAsync<int>(totalNumber);
            List<Cms_Sysconfig> result = await Db.Queryable<Cms_Sysconfig>().OrderByIF(orderByExpression != null, orderByExpression, orderByType).Where(whereExpression)
        ...
        {
            return await Db.Queryable<Cms_Sysconfig>().InSingleAsync(id);
        }
