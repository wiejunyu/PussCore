...
namespace Puss.Log
{
    public interface ILogService
    {
        ...
        void LogCollectPush(Exception Ex, string Url, string Token, ILoggerRepository Logger);
        ...
        /// <param name="sDetails">详细信息</param>
        /// <param name="Logger">Logger</param>
        void LogCollectPush(Exception Ex, string sDetails, ILoggerRepository Logger);
        ...
        /// <param name="sMessage">消息</param>
        /// <param name="Logger">Logger</param>
        void LogCollectPush(string sUrl, string sIP, string sMessage, ILoggerRepository Logger);
        ...
        /// <param name="sResult">结果</param>
        /// <param name="Logger">Logger</param>
        void LogCollectPush(string sUrl, string sHeaders, string sActionArguments, string sResult, ILoggerRepository Logger);
        #endregion
    }
}
