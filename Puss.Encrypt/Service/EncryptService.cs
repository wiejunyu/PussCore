...
namespace Puss.Encrypt
{
    public class EncryptService : IEncryptService
    {
        ...
        /// <returns></returns>
        public string DESDecrypst(string data, string key, string IV)
        {
        ...
        public string AES_Encrypt(string encryptString, string encryptKey)
        {
        ...
        public string AES_Decrypt(string decryptString, string decryptKey)
        {
            try
            {
        ...
        /// <returns></returns>
        public bool AES_EncryptFile(string InputFile, string OutputFile)
        {
            try
            {
        ...
        /// <param name="OutputFile"></param>
        /// <returns></returns>
        public bool AES_DecryptFile(string InputFile, string OutputFile)
        {
            try
            {
                string decryptKey = "www.iqidi.com";
        ...
        /// <returns></returns>
        public string GetMD5_32(string input)
        {
            MD5 md5 = MD5.Create();
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public string GetMD5_16(string input)
        {
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public string GetMD5_8(string input)
        {
        ...
        /// <param name="input"></param>
        /// <returns></returns>
        public string GetMD5_4(string input)
        {
            return GetMD5_32(input).Substring(8, 4);
        }

        public string MD5EncryptHash(String input)
        {
        ...
        public bool AddMD5(string path)
        {
            bool IsNeed = true;
        ...
        public string EncryptRC4wq(string str, string ckey)
        {
            int[] s = new int[256];
            for (int i = 0; i < 256; i++)
            {
        ...
        /// <param name="ckey">密钥</param>
        public string DecryptRC4wq(string str, string ckey)
        {
            int[] s = new int[256];
            for (int i = 0; i < 256; i++)
            {
